...
import LunaRobot.modules.sql.notes_sql as sql
from LunaRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from LunaRobot.__main__ import DATA_IMPORT
from LunaRobot.modules.helper_funsc.chat_status import user_admin
from LunaRobot.modules.helper_funsc.alternate import typing_action

# from LunaRobot.modules.rules import get_rules
import LunaRobot.modules.sql.rules_sql as rulessql

# from LunaRobot.modules.sql import warns_sql as warnssql
import LunaRobot.modules.sql.blacklist_sql as blacklistsql
from LunaRobot.modules.sql import disable_sql as disabledsql

# from LunaRobot.modules.sql import cust_filters_sql as filtersql
# import LunaRobot.modules.sql.welcome_sql as welcsql
import LunaRobot.modules.sql.locks_sql as locksql
from LunaRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Luna{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Luna{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Luna-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Luna{}.backup".format(chat_id))  # Cleaning file
