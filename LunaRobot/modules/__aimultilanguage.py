...
from LunaRobot import pbot as Luna
...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            await lel.edit("Livvy AI Already Activated In This Chat")
            return
        await lel.edit(
            f"Livvy AI Successfully Added For Users In The Chat {message.chat.id}"
        )
        ...
        if not Escobar:
            await lel.edit("Livvy AI Was Not Activated In This Chat")
            return
        await lel.edit(
            f"Livvy AI Successfully Deactivated For Users In The Chat {message.chat.id}"
        )
...
@Luna.on_message(
    filters.regex("Luna|Luna|Luna|Luna|Luna")
    & ~filters.bot
    & ~filters.via_bot
    & ~filters.forwarded
    & ~filters.reply
